...
local function playLidNudgeAnimation(part)
	...
	local goal = { CFrame = originalCFrame * CFrame.new(0, 0.3, 0) * CFrame.Angles(math.rad(10), 0, 0) }
...
local function playSFX_LootOpen(part)
	...
	sound.SoundId = "rbxasset://sounds/switch.wav" -- Placeholder; replace with custom SFX
	sound.Volume = 0.3 -- -10 dB approximately
	sound.Parent = part
	sound:Play()
